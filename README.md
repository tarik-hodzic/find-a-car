...
- Dynamic price calculation based on rental dates  
- Admin dashboard for managing cars and subscriptions  
- Responsive and user-friendly interface  

<h2>How to Run the Project</h2>

This project requires a local server environment.
...
2. Place the project inside the web server root directory  
